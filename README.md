...
=======
 ...
 fastq-dump SRR8180323
 fastq-dump SRR8180324
>>>>>>> fa9e060ccbe1bbc9c04d74dea8585e66205460aa
```
...
<<<<<<< HEAD
Before alignment, the methyl-seq reads should undergo quality control (QC) and trimming to remove low-quality reads and duplicate sequences generated by PCR amplification and adapter sequences. The suggested tool for QC is [FastQC](http://www.bioinformatics.babraham.ac.uk/projects/fastqc/). [Trim Galore](https://github.com/FelixKrueger/TrimGalore) and [BS-Seeker2](https://github.com/BSSeeker/BSseeker2) provides tools for trimming and removing duplicated reads.

1. Quality control
> Fastqc generates QC report for checking read quality, the output file name will look like `wt_r1_fastqc.html` and `met1_r2_fastqc.zip`. Click the HTML file to get your report.
=======
Before alignment, the methyl-seq reads should undergo quality control (QC) and trimming to remove low-quality reads and duplicate sequences generated by PCR amplification and adapter sequences. The suggested tool for QC is [FastQC](http://www.bioinformatics.babraham.ac.uk/projects/fastqc/). [Trim Galore](https://github.com/FelixKrueger/TrimGalore) and [BS-Seeker2](https://github.com/BSSeeker/BSseeker2) provides tools for trimming adapters and removing duplicated reads.
...
```bash
<<<<<<< HEAD
bs_seeker2-align.py -i met1_r1_rmdup_trimmed.fq -g ./Arabidopsis_thaliana/NCBI/TAIR10/Sequence/WholeGenomeFasta/genome.fa \
  --aligner=bowtie2 -o met1_r1_align.bam -d ./BS2_bt2_Index
bs_seeker2-align.py -i met1_r2_rmdup_trimmed.fq -g ./Arabidopsis_thaliana/NCBI/TAIR10/Sequence/WholeGenomeFasta/genome.fa \
  --aligner=bowtie2 -o met1_r2_align.bam -d ./BS2_bt2_Index
bs_seeker2-align.py -i met1_r3_rmdup_trimmed.fq -g ./Arabidopsis_thaliana/NCBI/TAIR10/Sequence/WholeGenomeFasta/genome.fa \
  --aligner=bowtie2 -o met1_r3_align.bam -d ./BS2_bt2_Index
=======
>>>>>>> fa9e060ccbe1bbc9c04d74dea8585e66205460aa
bs_seeker2-align.py -i wt_r1_rmdup_trimmed.fq -g ./Arabidopsis_thaliana/NCBI/TAIR10/Sequence/WholeGenomeFasta/genome.fa \
  --aligner=bowtie2 -o wt_r1_align.bam -d ./BS2_bt2_Index
bs_seeker2-align.py -i wt_r2_rmdup_trimmed.fq -g ./Arabidopsis_thaliana/NCBI/TAIR10/Sequence/WholeGenomeFasta/genome.fa \
  --aligner=bowtie2 -o wt_r2_align.bam -d ./BS2_bt2_Index
bs_seeker2-align.py -i wt_r3_rmdup_trimmed.fq -g ./Arabidopsis_thaliana/NCBI/TAIR10/Sequence/WholeGenomeFasta/genome.fa \
...
```bash
bs_seeker2-call_methylation.py -i met1_r1_align.bam -o met1_r1 -d ./BS2_bt2_Index/genome.fa_bowtie2
bs_seeker2-call_methylation.py -i met1_r2_align.bam -o met1_r2 -d ./BS2_bt2_Index/genome.fa_bowtie2
bs_seeker2-call_methylation.py -i met1_r3_align.bam -o met1_r3 -d ./BS2_bt2_Index/genome.fa_bowtie2
bs_seeker2-call_methylation.py -i wt_r1_align.bam -o wt_r1 -d ./BS2_bt2_Index/genome.fa_bowtie2
bs_seeker2-call_methylation.py -i wt_r2_align.bam -o wt_r2 -d ./BS2_bt2_Index/genome.fa_bowtie2
bs_seeker2-call_methylation.py -i wt_r3_align.bam -o wt_r3 -d ./BS2_bt2_Index/genome.fa_bowtie2
<<<<<<< HEAD
=======
bs_seeker2-call_methylation.py -i met1_r1_align.bam -o met1_r1 -d ./BS2_bt2_Index/genome.fa_bowtie2
bs_seeker2-call_methylation.py -i met1_r2_align.bam -o met1_r2 -d ./BS2_bt2_Index/genome.fa_bowtie2
...
# alignment
<<<<<<< HEAD
bs_seeker2-align.py -i met1_r1_rmdup_trimmed.fq -g ./Enterobacteriophage_lambda/NCBI/1993-04-28/Sequence/WholeGenomeFasta/genome.fa \
  --aligner=bowtie2 -o met1_r1_lambda.bam -m 3 -d ./BS2_lambda_Index
bs_seeker2-align.py -i met1_r2_rmdup_trimmed.fq -g ./Enterobacteriophage_lambda/NCBI/1993-04-28/Sequence/WholeGenomeFasta/genome.fa \
  --aligner=bowtie2 -o met1_r2_lambda.bam -m 3 -d ./BS2_lambda_Index
bs_seeker2-align.py -i met1_r3_rmdup_trimmed.fq -g ./Enterobacteriophage_lambda/NCBI/1993-04-28/Sequence/WholeGenomeFasta/genome.fa \
  --aligner=bowtie2 -o met1_r3_lambda.bam -m 3 -d ./BS2_lambda_Index
=======
>>>>>>> fa9e060ccbe1bbc9c04d74dea8585e66205460aa
bs_seeker2-align.py -i wt_r1_rmdup_trimmed.fq -g ./Enterobacteriophage_lambda/NCBI/1993-04-28/Sequence/WholeGenomeFasta/genome.fa \
  --aligner=bowtie2 -o wt_r1_lambda.bam -m 3 -d ./BS2_lambda_Index
bs_seeker2-align.py -i wt_r2_rmdup_trimmed.fq -g ./Enterobacteriophage_lambda/NCBI/1993-04-28/Sequence/WholeGenomeFasta/genome.fa \
  --aligner=bowtie2 -o wt_r2_lambda.bam -m 3 -d ./BS2_lambda_Index
bs_seeker2-align.py -i wt_r3_rmdup_trimmed.fq -g ./Enterobacteriophage_lambda/NCBI/1993-04-28/Sequence/WholeGenomeFasta/genome.fa \
  --aligner=bowtie2 -o wt_r3_lambda.bam -m 3 -d ./BS2_lambda_Index
<<<<<<< HEAD

# call methylation
bs_seeker2-call_methylation.py -i met1_r1_lambda.bam -o met1_r1_lambda -d BS2_lambda_Index/genome.fa_bowtie2/
bs_seeker2-call_methylation.py -i met1_r2_lambda.bam -o met1_r2_lambda -d BS2_lambda_Index/genome.fa_bowtie2/
bs_seeker2-call_methylation.py -i met1_r3_lambda.bam -o met1_r3_lambda -d BS2_lambda_Index/genome.fa_bowtie2/
bs_seeker2-call_methylation.py -i wt_r1_lambda.bam -o wt_r1_lambda -d BS2_lambda_Index/genome.fa_bowtie2/
bs_seeker2-call_methylation.py -i wt_r2_lambda.bam -o wt_r2_lambda -d BS2_lambda_Index/genome.fa_bowtie2/
bs_seeker2-call_methylation.py -i wt_r3_lambda.bam -o wt_r3_lambda -d BS2_lambda_Index/genome.fa_bowtie2/
=======
bs_seeker2-align.py -i met1_r1_rmdup_trimmed.fq -g ./Enterobacteriophage_lambda/NCBI/1993-04-28/Sequence/WholeGenomeFasta/genome.fa \
  --aligner=bowtie2 -o met1_r1_lambda.bam -m 3 -d ./BS2_lambda_Index
bs_seeker2-align.py -i met1_r2_rmdup_trimmed.fq -g ./Enterobacteriophage_lambda/NCBI/1993-04-28/Sequence/WholeGenomeFasta/genome.fa \
...
1. Prepare input files 
	- List CGmaps in TXT file `samples_list.txt` (obtained from [Step 3.1.3](#313-call-methylation))
